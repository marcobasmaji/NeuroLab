#include "WeightsAndBiasesCreator.h"
#include <QDebug>
 ...
 *
 int main(int argc, char *argv[]) {
    ...
    creator->createWeightsFile("conv1_weights", "/home/bianca/Documents/");
    creator->createBiasFile("biases_conv1.txt", "/home/bianca/Documents/");

    //conv2
    creator = new WeightsAndBiasesCreator(40, 15, 4, 4, 12347);
    creator->createWeightsFile("weights_conv2.txt", "/home/bianca/Documents/");
    creator->createBiasFile("biases_conv2.txt", "/home/bianca/Documents/");


    //dense
    creator = new WeightsAndBiasesCreator(6, 40, 5, 5, 12346);
    creator->createWeightsFile("weights_dense.txt", "/home/bianca/Documents/");
    creator->createBiasFile("biases_dense.txt", "/home/bianca/Documents/");
